      ...
      <div className="p-8 bg-white rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2">
          <div className="p-6 border border-blue-200 rounded-lg bg-blue-50">
            <h3 className="mb-2 text-lg font-semibold text-blue-900">Account Info</h3>
            ...
            <p className="text-sm text-blue-700">
              <strong>Role:</strong> <span className="font-semibold uppercase">{user?.role}</span>
            </p>
          </div>
          <div className="p-6 border border-green-200 rounded-lg bg-green-50">
            <h3 className="mb-2 text-lg font-semibold text-green-900">Order Summary</h3>
